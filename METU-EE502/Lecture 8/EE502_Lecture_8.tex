...
$\iff \ \lim_{t \to \infty } e^{J_i t} = M_i < \infty \ \forall i \ \iff \lbrace \mathrm{Re}\lbrace \lambda_i \rbrace < 0 \ \mathrm{or} \ \left\lbrace \mathrm{Re}\lbrace \lambda_i \rbrace = 0 \ \mathrm{and} \ J_i \in \mathbb{R} \rbrace \right\rbrace \ \forall i$  
%
\item A DT LTI system is \textit{s.i.s.L} 

$\iff \ \lim_{k \to \infty } J_i^k = M_i < \infty \ \forall i \ \iff \lbrace | \lambda_i | < 1 \ \mathrm{or} \ \left\lbrace | \lambda_i | = 1 \ \mathrm{and} \ J_i \in \mathbb{R} \rbrace \right\rbrace \ \forall i$  
\end{itemize}
...
$\iff \ \exists i \ \ \lim_{t \to \infty } e^{J_i t} = \infty \ \iff \exists i \lbrace \mathrm{Re}\lbrace \lambda_i \rbrace > 0 \ \mathrm{or} \ \left\lbrace \mathrm{Re}\lbrace \lambda_i \rbrace = 0 \ \mathrm{and} \ J_i \in \mathbb{R}^{n \times n} , n>1 \rbrace \right\rbrace$  
%
\item A DT LTI system is \textit{unstable} 

$\iff \ \exists i \ \lim_{k \to \infty } J_i^k = \infty \ \iff \exists i \lbrace | \lambda_i | > 1 \ \mathrm{or} \ \left\lbrace | \lambda_i | = 1 \ \mathrm{and} \ J_i \in \mathbb{R}^{n \times n} , n>1 \rbrace \right\rbrace$  
\end{itemize}
...
\end{align*}
%
$P$ is well defined since all eigenvalues of $A$ are in the Open Left-Half Plane (OLP), and 
