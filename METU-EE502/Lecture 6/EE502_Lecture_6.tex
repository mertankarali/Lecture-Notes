...
\begin{align*}
 ...
 \\
 &= C A^k \left( - \left(z_0 - A z_0 \right)^{-1} B \right) + \left( C \left(z_0 I - A \right)^{-1} B + D \right) z_0^k
 \\
  &= \quad \quad  \quad  \underbrace{C A^k \bar{x}_0}_{transient}  \quad \quad \quad \ \ \, +
   ...
   \\
   \\
   \bar{x}_0 &= \left( - \left(z_0 - A z_0 \right)^{-1} B \right) \ , \ \mathrm{quasi} \ \mathrm{initial-condition}
   \\
