...
(feed-forward and feed-back). It is based on the frequency response
...
which does not croses any zeros (roots of $N(s)$) or poles (roots of $D(s)$)
...
the imaginary axis. Since we are interested in finding the unstable
...
%
  \item Now we should be careful with mapping the infinite radius
   ...
   is the conjugate of the polar plot with reverse direction. 
\end{enumerate}
